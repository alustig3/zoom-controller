<!-- vscode-markdown-toc -->
* [Connecting to Bluetooth](#ConnectingtoBluetooth)
	* [Mac](#Mac)
	* [Windows](#Windows)
* [Disconnecting Bluetooth](#DisconnectingBluetooth)
	* [Mac](#Mac-1)
	* [Windows](#Windows-1)
* [Turn on](#Turnon)
* [Turn off](#Turnoff)
* [Controlling Zoom!](#ControllingZoom)
	* [Adjust volume](#Adjustvolume)
	* [Send Shortcuts on Mac](#SendShortcutsonMac)
	* [Send Shortcuts on Windows](#SendShortcutsonWindows)
* [Changing the OS](#ChangingtheOS)
	* [Use with Mac](#UsewithMac)
	* [Use with Windows](#UsewithWindows)
* [Desktop notifications](#Desktopnotifications)
	* [Mac Notifications Setup](#MacNotificationsSetup)
	* [Windows notifications setup](#Windowsnotificationssetup)
	* [YouTube Controller](#YouTubeController)
		* [Switch into YouTube mode](#SwitchintoYouTubemode)
* [Building](#Building)
	* [Bill of Materials](#BillofMaterials)
* [Buying  ¯\\\_(ツ)_/¯](#Buying__)
...
I created this device to make interacting with the Zoom software faster and more pleasant. 
...
I also use mine as a remote for watching youtube videos. See [getting fancy](#getting-fancy) to 
...
## <a name='ConnectingtoBluetooth'></a>Connecting to Bluetooth
...
## <a name='DisconnectingBluetooth'></a>Disconnecting Bluetooth
...
## <a name='ControllingZoom'></a>Controlling Zoom!

### <a name='Adjustvolume'></a>Adjust volume
Rotate the **VOLUME** knob clockwise to increase volume, counterclockwise to decrease volume.

### <a name='SendShortcutsonMac'></a>Send Shortcuts on Mac
...
### <a name='SendShortcutsonWindows'></a>Send Shortcuts on Windows
...
## <a name='ChangingtheOS'></a>Changing the OS
The keyboard shortcuts for Zoom are different depending on whether you are on a Mac or Windows machine. So you will need to tell Zoom Controller once which operating system you are using.

### <a name='UsewithMac'></a>Use with Mac
...
### <a name='UsewithWindows'></a>Use with Windows
- Press down the **VOLUME** button. 
...
# Getting fancy
## <a name='Desktopnotifications'></a>Desktop notifications
...
### <a name='MacNotificationsSetup'></a>Mac Notifications Setup
...
### <a name='Windowsnotificationssetup'></a>Windows notifications setup
...
### <a name='YouTubeController'></a>YouTube Controller
...
#### <a name='SwitchintoYouTubemode'></a>Switch into YouTube mode
- Press and hold the VOLUME knob
- Press and release the CAMERA button
With this setup, Zoom controller does the following


# How do I get one?
## <a name='Building'></a>Building
### <a name='BillofMaterials'></a>Bill of Materials
...
## <a name='Buying__'></a>Buying  ¯\\\_(ツ)_/¯
If people are interested, I may consider buying some parts in bulk and selling the controllers on [Tindie](https://www.tindie.com/) or [Etsy](https://www.etsy.com/). Let

# Feedback
If you have questions, comments, or are interested in buying a Zoom Controller:

<div style="">
  <a href="https://forms.gle/rxcJuvHoePF4XZsw5" style="
  ...
  font-size: 20px;
  border-radius:15px">Leave a comment and/or sign up for a future notification</a>
</div>
